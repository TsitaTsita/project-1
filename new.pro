...
<head>
    ...
    <title>Tseyon G.for | Data Scientist & Analyst</title>
...
" class="text-blue-600 hover:underline">Water Quality and Infrastructure Analysis</a></h4>
        ...
        <a href="https://github.com"><img src="Maji_first_page.png" alt="Water Quality and Infrastructure Analysis" class="rounded-xl"></a>
    </div>
    <div class="mb-4">
